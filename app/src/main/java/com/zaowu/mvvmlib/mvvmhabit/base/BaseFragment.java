package com.zaowu.mvvmlib.mvvmhabit.base;
...
import com.zaowu.mvvmlib.mvvmhabit.bus.Messenger;
import com.zaowu.mvvmlib.mvvmhabit.utils.MaterialDialogUtils;
...
public abstract class BaseFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends RxFragment implements IBaseView {
     ...
     * @return
     */
    public <T extends ViewModel> T createViewModel(BaseFragment<V, VM> fragment, Class cls) {
